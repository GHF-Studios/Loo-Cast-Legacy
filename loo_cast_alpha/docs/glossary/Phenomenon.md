...
A Phenomenon is a primary USF world-state and world-generation carrier.
...
Phenomenon implementations may define their own significance thresholds and may use metric APIs or metric-combination
APIs to decide when chunk-local data becomes phenomenon-relevant.

Open pressure:
The relationship between phenomena, metrics, former DPT/ZLM/Zone concepts, chunk-local state, and detail
generation/re-aggregation is still underexplored.
